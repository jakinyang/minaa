    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.statsContainer}>
        <View style={styles.statsBox}>
          ...
          <Text style={[styles.text, styles.subText]}>reports</Text>
        </View>
      ...
      <View style={{ alignItems: "center" }}>
        <View style={styles.recentItem}>
          ...
          <View style={{ width: 250 }}>
            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
              Made report <Text style={{ fontWeight: "400", fontFamily: 'OpenSans_400Regular', }}>No.100</Text>  in  <Text style={{ fontWeight: "400", fontFamily: 'OpenSans_400Regular', }}>Vancouver area</Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.recentItem}>
          ...
          <View style={{ width: 250 }}>
            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
              Saved a new report <Text style={{ fontWeight: "400" }}>NO.89</Text>
            </Text>
          </View>
        </View>
      </View>
